...
public class InformationCommand : InteractionModuleBase<ShardedInteractionContext>
{
    ...
    public async Task ExecuteCommand()
    {
        ...
        _ = await Context.ReplyWithEmbedAsync("Information",
            ...
            $"Developer: {(Context.Guild is null ? $"{appInfo.Owner.Username}" : appInfo.Owner.Mention)}\n" +
            ...
            $"Description: {(string.IsNullOrWhiteSpace(appInfo.Description) ? "N/A" : appInfo.Description)}\n" +

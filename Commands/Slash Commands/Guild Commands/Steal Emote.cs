...
public class StealEmoteCommand : InteractionModuleBase<ShardedInteractionContext>
{
    ...
    private async Task StealEmoteAsync(string? emote, string? imageUrl, string? name)
    {
        ...
        {
            await Context.ReplyWithEmbedAsync("Error Occurred", "Please enter an emote or url.", deleteTimer: 60);
            return;
        }
        ...
        {
            await Context.ReplyWithEmbedAsync("Error Occurred", "Please enter a name.", deleteTimer: 60);
            return;
        }
        ...
        await Context.ReplyWithEmbedAsync("Emote Stealer", "Successfully added emote.", "https://nebulamods.ca", guildemote.Url, string.Empty, deleteTimer: 60);
    }
